  ...
  return (
    <View style={$header}>
      <TouchableOpacity
        ...
        onPress={sourceDashboard ? onDrawerToggle : () => { navigation?.dispatch(StackActions.pop(1)) }}
      >
          ...
          <>
            <View style={$balanceContainer}>
              ...
              <View style={$infoContainer}>
                ...
                <Icon icon="info" size={12} color={colors.palette.neutral400} containerStyle={$infoIcon} />
              </View>
            </View>
